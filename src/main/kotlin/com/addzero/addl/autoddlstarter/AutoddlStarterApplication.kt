...
//import com.addzero.addl.autoddlstarter.testentity.Book
////import com.addzero.addl.autoddlstarter.generator.ddl.entity.DDLContext
...
//
//
//    val sysUserClass = Book::class.java
//    //获取sql生成器
//    val databaseDDLGenerator = getDatabaseDDLGenerator(dbType)
//
//    //获取元数据提取器
//    val ddlContexts: List<DDLContext> = extractDDLContext(sysUserClass)
//
//    ddlContexts.forEach {
